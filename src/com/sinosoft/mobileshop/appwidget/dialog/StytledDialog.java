...
public class StytledDialog {
    ...
    public static AlertDialog showMdAlert(Activity activity, String title, String msg,
                                          ...
                                          final McDialogListener listener){
	...
	@SuppressLint("NewApi")
	public static AlertDialog showMdAlert(Context activity, String title,
			String msg, String firstTxt,
			boolean outsideCancleable, boolean cancleable,
			final McDialogListener listener) {
    ...
    public static Dialog showIosAlertVertical(Context activity,String title, String msg,
            ...
            boolean outsideCancleable, boolean cancleable,
            final McDialogListener listener){
	return showIosAlert(activity,true,title,msg,firstTxt,outsideCancleable,cancleable,listener);
	}
    ...
    private static Dialog showIosAlert(Context context, boolean isButtonVerticle, String title, String msg,
		...
		int  height =   assigIosAlertView(context,dialog,isButtonVerticle,title,msg,firstTxt,"", "",listener);
    ...
    public static Dialog showIosSingleChoose(Context context,List<String> words,boolean outsideCancleable, boolean cancleable,
                                             final McItemDialogListener listener){
        Dialog dialog = buildDialog(context,cancleable,outsideCancleable);
    ...
    private static int assignListDialogView(final Context context, final Dialog dialog, final List<String> words, final McItemDialogListener listener) {
    ...
    private static int assignBottomListDialogView(final Context context,  final Dialog dialog,
                                                   final List<String> words, String bottomTxt, final McItemDialogListener listener) {
