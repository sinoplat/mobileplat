package com.sinosoft.common.base.model;
...
public class SuperModel {
	...
	private static Map<String, SuperModel> mInstanceMap = new HashMap<String, SuperModel>();
	protected SharedPreferences mSP;
	protected SharedPreferences.Editor mEditor;

	public SuperModel() {
		mSP = mContext.getSharedPreferences(mContext.getPackageName(),
				Context.MODE_PRIVATE);
		mEditor = mSP.edit();
		mObjectCachePath = mContext.getExternalFilesDir(OBJECT_CACHE)
				.getAbsolutePath();
	}
