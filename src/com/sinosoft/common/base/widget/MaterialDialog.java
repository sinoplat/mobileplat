package com.sinosoft.common.base.widget;
...
/**
 * MaterialDialog 提示框，可设置title，content，两个按钮监听器 Created on 2016/8/3
 */
...
public class MaterialDialog extends AlertDialog {
	...
	public static class Builder {
		...
		public MaterialDialog create() {
			...
			View dialogContent = LayoutInflater.from(mContext).inflate(
					R.layout.view_material_dialog, null);

			dialog.mTitle = (TextView) dialogContent.findViewById(R.id.title);
			dialog.mContent = (TextView) dialogContent
					.findViewById(R.id.content);
			dialog.mPositiveButton = (TextView) dialogContent
					.findViewById(R.id.positive_button);
			dialog.mPassiveButton = (TextView) dialogContent
					.findViewById(R.id.passive_button);
			...
			dialog.setContentView(dialogContent, new ViewGroup.LayoutParams(
